page 50177 "Outgoing Fund Alert API"
{
    APIGroup = 'BOC';
    APIPublisher = 'PB';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'outgoingFundAlertAPI';
    DelayedInsert = true;
    EntityName = 'outgoingFundAlert';
    EntitySetName = 'outgoingFundAlerts';
    PageType = API;
    SourceTable = "Outgoing Fund Alert";

    //https://api.businesscentral.dynamics.com/v2.0/ba92f9e8-c19e-47b4-88f8-ce3df6492b8f/SandBox_DEV/api/PB/BOS/v2.0/companies(1324cb6a-b638-ef11-8e51-6045bde99b08)/outgoingFundAlerts
    layout
    {
        area(Content)
        {
