tableextension 50102 VendorLedEntryExt extends "Vendor Ledger Entry"
{
    fields
    {
        ...
        //PS006 Start
        field(50301; "Record Type"; Text[10])
        {
            DataClassification = ToBeClassified;
        //Editable = false;
        }
        field(50302; "Exported to Concur"; Boolean)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(50303; "PB Concur Invoice"; Boolean)
        {
            DataClassification = ToBeClassified;
        //Editable = false;
        }
