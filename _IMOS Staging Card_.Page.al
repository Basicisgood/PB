page 50166 "IMOS Staging Card"
{
    Caption = 'IMOS Staging Card';
    PageType = Card;
    SourceTable = "IMOS Invoice Staging Table";
    ApplicationArea = all;
    DataCaptionFields = transNo;
    Editable = true;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(invoiceDetails; IMOSInvLineAPI)
            {
                SubPageLink = "Invoice Entry No."=field("Entry No.");
                ApplicationArea = All;
            }
        }
    }
