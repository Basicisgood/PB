table 50148 "HSBC Inbound Staging"
{
    ...
    fields
    {
        ...
        field(18; EntryTransCode; Text[30])
        {
            DataClassification = ToBeClassified;
        }
        ...
        //#190 TEC.VJ 29012025<<
        field(52; "Opening Available"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(53; "Opening Booked"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(54; "Closing Booked"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(55; "Closing Available"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(56; "MsgId"; text[30])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(58; "Executed Scenario"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
    }
    keys
    {
        ...
        key(PK2; Processed, Status, EntryValueDate, EntryStatus)
        {
        }
        key(PK3; Processed, Status, EntryValueDate, EntryStatus, EntryCrDrInd, "Additional Entry Information")
        {
        }
    }
}
