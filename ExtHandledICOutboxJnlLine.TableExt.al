tableextension 50134 ExtHandledICOutboxJnlLine extends "Handled IC Outbox Jnl. Line"
{
    fields
    {
        field(50100; "PB Account No"; Code[20])
        {
            Caption = 'PB Account No';
        ...
        //PS003 End
        field(50227; "Bank Document No."; Code[20])
        {
            Caption = 'Bank Document No.'; //#134 TEC.VJ
            DataClassification = ToBeClassified;
        }
