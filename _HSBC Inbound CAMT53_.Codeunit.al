codeunit 50160 "HSBC Inbound CAMT53"
{
    ...
    var
        ...
        StartDate: Date;
        EndDate: Date;
        HSBCXml: XmlPort "HSBC Inbound CAMT 53";
    begin
        BankAccount.Reset();
        ...
        if BankAccount.FindFirst()then repeat // ClearAll();
                ...
                if not HSBCXml.Import()then begin
                    ...
                    ErrorLog."Statement Date":=Today - 1;
    ...
    begin
        ...
        if isIntra then begin
            ...
            jObj.Add('transactionDate', Format(Today - 1, 0, '<Year4>-<Month,2>-<Day,2>'));
