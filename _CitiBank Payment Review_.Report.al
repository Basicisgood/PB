report 50118 "CitiBank Payment Review"
{
    ApplicationArea = all;
    DefaultLayout = RDLC;
    //RDLCLayout = './Citi review layout.rdl';
    RDLCLayout = './Citibank payment review layout.rdl';
    Caption = 'Citi Review';
        ...
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            dataitem("Integer"; Integer)
            {
                ...
                dataitem("Gen. Journal Line"; "Gen. Journal Line")
                {
                    ...
                    column(PostingDate_GenJnlLine; PostingDate)
                    {
                    }
                    ...
                    column(ValueDate; GJBatch."Value Date")
                    {
                    }
                    column(PaymentTypeValue; PaymentTypeValue)
                    {
                    }
                    column(GLSetup_LCY; BalCurrencyCode)
                    {
                    }
                    column(Bank_Document_No_; "Bank Document No.")
                    {
                    }
                    column(Charges_Bearer; "Charges Bearer")
                    {
                    }
                    ...
                    column(BenBankName; BenBankName)
                    {
                    }
                    column(TransferInformation; TransferInformation)
                    {
                    }
                    column(PAymentSetCode; PAymentSetCode)
                    {
                    }
                    column(paymentdetails; paymentdetails)
                    {
                    }
                    column(SWIFTBIC; SWIFTBIC)
                    {
                    }
                    column(BeniBankCountryCode; BeniBankCountryCode)
                    {
                    }
                    column(BenificieryCountryjurisdiction; BenificieryCountryjurisdiction)
                    {
                    }
                    column(HKClearingBank; HKClearingBank)
                    {
                    }
                    column(fedwire; fedwire)
                    {
                    }
                    column(Benificierynam; Benificierynam)
                    {
                    }
                    column(Benificciyaddress1; Benificciyaddress1)
                    {
                    }
                    column(Benificciyaddress2; Benificciyaddress2)
                    {
                    }
                    column(BenificieryAccno; BenificieryAccno)
                    {
                    }
                    column(IBANNo; IBANNo)
                    {
                    }
                    column(Coorrsspondentbankname; Coorrsspondentbankname)
                    {
                    }
                    column(CoorrsspondentbankSWIFTBIC; CoorrsspondentbankSWIFTBIC)
                    {
                    }
                    column(CoorrsspondentbankAccno; CoorrsspondentbankAccno)
                    {
                    }
                    column(CoorrsspondentbankCountrycode; CoorrsspondentbankCountrycode)
                    {
                    }
                    column(PaymentDetailsofbeneficiery; PaymentDetailsofbeneficiery)
                    {
                    }
                    column(CodeWord; CodeWord)
                    {
                    }
                    column(TransactionType; TransactionType)
                    {
                    }
                    column(Benificciyaddress3; Benificciyaddress3)
                    {
                    }
                    column(WorldLinkID; WorldLinkID)
                    {
                    }
                    column(CompanyNameciti; CompanyName)
                    {
                    }
                    column(CompanyAddres1; CompanyAddres1)
                    {
                    }
                    column(CompanyAddres2; CompanyAddres2)
                    {
                    }
                    column(CompanyAddres3; CompanyAddres3)
                    {
                    }
                    column(ChargesAccount; ChargesAccount)
                    {
                    }
                    column(BeneficieryBankRoutingMethod; BeneficieryBankRoutingMethod)
                    {
                    }
                    column(CodeWordDescription1; CodeWordDescription1)
                    {
                    }
                    column(CodeWordDescription2; CodeWordDescription2)
                    {
                    }
                    column(FXContract; FXContract)
                    {
                    }
                    column(ExchangeRate; "Exchange Rate")
                    {
                    }
                    column(OrderingPartyIDType; OrderingPartyIDType)
                    {
                    }
                    column(OrderingPartyID; OrderingPartyID)
                    {
                    }
                    column(OrderingPartyName; OrderingPartyName)
                    {
                    }
                    column(Branch; Branch)
                    {
                    }
                    column(SWIFTBEN; SWIFTBEN)
                    {
                    }
                    column(Message_to_Recipient; "Message to Recipient")
                    {
                    }
                    column(Purpose_Code; "Purpose Code")
                    {
                    }
                    column(Payment_Purpose; "Payment Purpose")
                    {
                    }
                    column(IFSC_Code; ifsc_code)
                    {
                    }
                    column(BalBankAccName; BalBankAccName)
                    {
                    }
                    column(BalBankAcNo; BalBankAcNo)
                    {
                    }
                    column(Instruction_to_Bank; "Instruction to Bank")
                    {
                    }
                    column(Trans__Currency; "Trans. Currency")
                    {
                    }
                    column(Trans__Amt_; "Trans. Amt.")
                    {
                    }
                    ...
                    column(Debit_Amount; "Amount (LCY)")
                    {
                    }
                    ...
                    begin
                        ...
                        if not EmptyLine()then begin
                            ...
                            if "Account No." <> '' then case "Account Type" of "Account Type"::"G/L Account": begin
                                    if("Gen. Bus. Posting Group" <> '') or ("Gen. Prod. Posting Group" <> '') or ("VAT Bus. Posting Group" <> '') or ("VAT Prod. Posting Group" <> '')then if "Gen. Posting Type" = "Gen. Posting Type"::" " then AddError(StrSubstNo(Text002, FieldCaption("Gen. Posting Type")));
                                ...
                                "Account Type"::Customer, "Account Type"::Vendor, "Account Type"::Employee: begin
                                    if "Gen. Posting Type" <> "Gen. Posting Type"::" " then AddError(StrSubstNo(Text004, FieldCaption("Gen. Posting Type"), FieldCaption("Account Type"), "Account Type"));
                                    ...
                                    if "Document Type" <> "Document Type"::" " then if "Account Type" = "Account Type"::Customer then case "Document Type" of "Document Type"::"Credit Memo": WarningIfPositiveAmt("Gen. Journal Line");
                                ...
                                "Account Type"::"Bank Account": begin
                                    ...
                                    if("Gen. Bus. Posting Group" <> '') or ("Gen. Prod. Posting Group" <> '') or ("VAT Bus. Posting Group" <> '') or ("VAT Prod. Posting Group" <> '')then AddError(StrSubstNo(Text005, FieldCaption("Gen. Bus. Posting Group"), FieldCaption("Gen. Prod. Posting Group"), FieldCaption("VAT Bus. Posting Group"), FieldCaption("VAT Prod. Posting Group"), FieldCaption("Account Type"), "Account Type"));
                                    if "Job No." <> '' then AddError(StrSubstNo(Text009, FieldCaption("Job No.")));
                                    if(Amount < 0) and ("Bank Payment Type" = "Bank Payment Type"::"Computer Check")then if not "Check Printed" then AddError(StrSubstNo(Text010, FieldCaption("Check Printed")));
                                end;
                            ...
                            if "Bal. Account No." <> '' then case "Bal. Account Type" of "Bal. Account Type"::"G/L Account": begin
                                    if("Bal. Gen. Bus. Posting Group" <> '') or ("Bal. Gen. Prod. Posting Group" <> '') or ("Bal. VAT Bus. Posting Group" <> '') or ("Bal. VAT Prod. Posting Group" <> '')then if "Bal. Gen. Posting Type" = "Bal. Gen. Posting Type"::" " then AddError(StrSubstNo(Text002, FieldCaption("Bal. Gen. Posting Type")));
                                ...
                                "Bal. Account Type"::Customer, "Bal. Account Type"::Vendor: begin
                                    if "Bal. Gen. Posting Type" <> "Bal. Gen. Posting Type"::" " then AddError(StrSubstNo(Text004, FieldCaption("Bal. Gen. Posting Type"), FieldCaption("Bal. Account Type"), "Bal. Account Type"));
                                    ...
                                    if "Document Type" <> "Document Type"::" " then if("Bal. Account Type" = "Bal. Account Type"::Customer) = ("Document Type" in["Document Type"::Payment, "Document Type"::"Credit Memo"])then WarningIfNegativeAmt("Gen. Journal Line")
                                        else
                                            WarningIfPositiveAmt("Gen. Journal Line");
                            ...
                            if("Account No." <> '') and not "System-Created Entry" and (Amount = 0) and not GenJnlTemplate.Recurring and not "Allow Zero-Amount Posting" and ("Account Type" <> "Account Type"::"Fixed Asset")then WarningIfZeroAmt("Gen. Journal Line");
                            ...
                            else if "Gen. Journal Batch"."No. Series" <> '' then if IsGapInNosForDocNo("Gen. Journal Line")then AddError(Text016);
                            ...
                            if("Account Type" <> "Account Type"::"Bank Account") and ("Bal. Account Type" <> "Bal. Account Type"::"Bank Account")then if GenJnlLine2."Bank Payment Type" <> GenJnlLine2."Bank Payment Type"::" " then AddError(StrSubstNo(Text009, FieldCaption("Bank Payment Type")));
                            if("Account No." <> '') and ("Bal. Account No." <> '')then begin
                                PurchPostingType:=false;
                                SalesPostingType:=false;
                            end;
                            if "Account No." <> '' then CheckAccountTypes("Account Type", AccName);
                        ...
                        CompanyAddres3:='';
                        ChargesAccount:='';
                        BeneficieryBankRoutingMethod:='';
                        CodeWordDescription1:='';
                        CodeWordDescription2:='';
                        FXContract:='';
                        ExchangeRate:='';
                        OrderingPartyIDType:='';
                        OrderingPartyID:='';
                        ...
                        SWIFTBIC:='';
                        BeniBankCountryCode:='';
                        BenificieryCountryjurisdiction:='';
                        HKClearingBank:='';
                        fedwire:='';
                        SWIFTBEN:='';
                        Benificierynam:='';
                        ...
                        ABABSBNo:='';
                        Benificciyaddress2:='';
                        CoorrsspondentbankAccno:='';
                        CoorrsspondentbankCountrycode:='';
                        PaymentDetailsofbeneficiery:='';
                        CodeWord:='';
                        EmployeeContractNo:='';
                        TransferInformation:='';
                        PAymentSetCode:='';
                        ACHBathRef:='';
                        Coorrsspondentbankname:='';
                        CoorrsspondentbankSWIFTBIC:='';
                        paymentdetails:='';
                        IBANNo:='';
                        BenificieryAccno:='';
                        if "Account Type" = "Account Type"::Vendor then begin
                            VendRec.Reset();
                            if VendRec.get("Account No.")then begin
                                BankRecNew.Reset();
                                if BankRecNew.GET(VendRec."No.", "Recipient Bank Account")then begin
                                    BenBankName:=BankRecNew.Name;
                                    SWIFTBIC:=BankRecNew."SWIFT Code";
                                    BeniBankCountryCode:=BankRecNew."Country/Region Code";
                                    HKClearingBank:=BankRecNew."Bank Clearing Code";
                                    fedwire:=BankRecNew."ABA/BSB No.";
                                    ifsc_code:=BankRecNew."IFSC Code";
                                    Benificierynam:=BankRecNew."Beneficiary Name"; //NT_ 17-02-2025
                                    if(BankRecNew."Beneficiary Name 2" = '') and (BankRecNew."Beneficiary Name 3" = '')then begin
                                        // Benificierynam := BankRecNew."Beneficiary Name" + BankRecNew."Beneficiary Name 2";
                                        Benificciyaddress1:=BankRecNew.Address;
                                        Benificciyaddress2:=BankRecNew."Address 2";
                                        Benificciyaddress3:=BankRecNew."Address 3";
                                    end
                                    else if(BankRecNew."Beneficiary Name 2" <> '') and (BankRecNew."Beneficiary Name 3" = '')then begin
                                            Benificciyaddress1:=BankRecNew."Beneficiary Name 2";
                                            Benificciyaddress2:=BankRecNew.Address;
                                            Benificciyaddress3:=BankRecNew."Address 2";
                                        end
                                        else if(BankRecNew."Beneficiary Name 2" <> '') and (BankRecNew."Beneficiary Name 3" <> '')then begin
                                                Benificciyaddress1:=BankRecNew."Beneficiary Name 2";
                                                Benificciyaddress2:=BankRecNew."Beneficiary Name 3";
                                                Benificciyaddress3:=BankRecNew.Address;
                                            end
                                            else if(BankRecNew."Beneficiary Name 2" = '') and (BankRecNew."Beneficiary Name 3" <> '')then begin
                                                    Benificciyaddress1:=BankRecNew."Beneficiary Name 3";
                                                    Benificciyaddress2:=BankRecNew.Address;
                                                    Benificciyaddress3:=BankRecNew."Address 2";
                                                end
                                                else
                                    ...
                                    CoorrsspondentbankAccno:=BankRecNew."Correspondent Bank Account No.";
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then CoorrsspondentbankCountrycode:=''
                                    else
                                        CoorrsspondentbankCountrycode:=BankRecNew."Corresp. Country/Region Code";
                                    PaymentDetailsofbeneficiery:="Gen. Journal Line"."Purpose Code";
                                    CountryegionRec.Reset();
                                    if CountryegionRec.Get(BankRecNew."Country/Region Code")then CodeWord:=CountryegionRec."Purpose Code (Citi)  Prefix";
                                    BenificieryCountryjurisdiction:=CountryegionRec.Name;
                                    EmployeeContractNo:='';
                                    TransferInformation:="Gen. Journal Line"."Message to Recipient";
                                    PAymentSetCode:="Gen. Journal Line"."Payment Set Code";
                                    ACHBathRef:='';
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then Coorrsspondentbankname:=''
                                    else
                                        Coorrsspondentbankname:=BankRecNew."Correspondent Bank Name";
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then CoorrsspondentbankSWIFTBIC:=''
                                    else
                                        CoorrsspondentbankSWIFTBIC:=BankRecNew."Correspondent Swift Code";
                                    paymentdetails:="Gen. Journal Line"."Message to Recipient" + '' + "Gen. Journal Line"."Applied Entries to XML";
                                    BenificieryAccno:=BankRecNew."Bank Account No.";
                                    IBANNo:=BankRecNew.IBAN;
                                    Branch:=BankRecNew.Branch;
                                    CurrExchRate.Reset();
                                    if "Gen. Journal Line"."Currency Code" <> '' then CurrExchRate.SetRange("Currency Code", "Gen. Journal Line"."Currency Code");
                                    if CurrExchRate.FindLast()then ExchangeRate:=Format(CurrExchRate."Relational Exch. Rate Amount");
                                end;
                            end;
                        end;
                        if "Account Type" = "Account Type"::Customer then begin
                            ...
                            if CustRec.get("Account No.")then begin
                                CustBankRecNew.Reset();
                                if CustBankRecNew.GET(CustRec."No.", "Recipient Bank Account")then begin
                                    BenBankName:=CustBankRecNew.Name;
                                    SWIFTBIC:=CustBankRecNew."SWIFT Code";
                                    BeniBankCountryCode:=CustBankRecNew."Country/Region Code";
                                    HKClearingBank:=CustBankRecNew."Bank Clearing Code";
                                    fedwire:=CustBankRecNew."ABA/BSB No.";
                                    ifsc_code:=CustBankRecNew."IFSC Code";
                                    Benificierynam:=CustBankRecNew."Beneficiary Name"; //NT_ 17-02-2025
                                    if(CustBankRecNew."Beneficiary Name 2" = '') and (CustBankRecNew."Beneficiary Name 3" = '')then begin
                                        // Benificierynam := CustBankRecNew."Beneficiary Name" + CustBankRecNew."Beneficiary Name 2";
                                        Benificciyaddress1:=CustBankRecNew.Address;
                                        Benificciyaddress2:=CustBankRecNew."Address 2";
                                        Benificciyaddress3:=CustBankRecNew."Address 3";
                                    end
                                    else if(CustBankRecNew."Beneficiary Name 2" <> '') and (CustBankRecNew."Beneficiary Name 3" = '')then begin
                                            Benificciyaddress1:=CustBankRecNew."Beneficiary Name 2";
                                            Benificciyaddress2:=CustBankRecNew.Address;
                                            Benificciyaddress3:=CustBankRecNew."Address 2";
                                        end
                                        else if(CustBankRecNew."Beneficiary Name 2" <> '') and (CustBankRecNew."Beneficiary Name 3" <> '')then begin
                                                Benificciyaddress1:=CustBankRecNew."Beneficiary Name 2";
                                                Benificciyaddress2:=CustBankRecNew."Beneficiary Name 3";
                                                Benificciyaddress3:=CustBankRecNew.Address;
                                            end
                                            else if(CustBankRecNew."Beneficiary Name 2" = '') and (CustBankRecNew."Beneficiary Name 3" <> '')then begin
                                                    Benificciyaddress1:=CustBankRecNew."Beneficiary Name 3";
                                                    Benificciyaddress2:=CustBankRecNew.Address;
                                                    Benificciyaddress3:=CustBankRecNew."Address 2";
                                                end
                                                else
                                    ...
                                    CoorrsspondentbankAccno:=CustBankRecNew."Correspondent Bank Account No.";
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then CoorrsspondentbankCountrycode:=''
                                    else
                                        CoorrsspondentbankCountrycode:=CustBankRecNew."Corresp. Country/Region Code";
                                    PaymentDetailsofbeneficiery:="Gen. Journal Line"."Purpose Code";
                                    CountryegionRec.Reset();
                                    if CountryegionRec.Get(CustBankRecNew."Country/Region Code")then CodeWord:=CountryegionRec."Purpose Code (Citi)  Prefix";
                                    BenificieryCountryjurisdiction:=CountryegionRec.Name;
                                    EmployeeContractNo:='';
                                    TransferInformation:="Gen. Journal Line"."Message to Recipient";
                                    PAymentSetCode:="Gen. Journal Line"."Payment Set Code";
                                    ...
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then Coorrsspondentbankname:=''
                                        ...
                                        Coorrsspondentbankname:=CustBankRecNew."Correspondent Bank Name";
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then CoorrsspondentbankSWIFTBIC:=''
                                    else
                                        CoorrsspondentbankSWIFTBIC:=CustBankRecNew."Correspondent Swift Code";
                                    paymentdetails:="Gen. Journal Line"."Message to Recipient" + '' + "Gen. Journal Line"."Applied Entries to XML";
                                    BenificieryAccno:=CustBankRecNew."Bank Account No.";
                                    IBANNo:=CustBankRecNew.IBAN;
                                    Branch:=CustBankRecNew.Branch;
                                    CurrExchRate.Reset();
                                    if "Gen. Journal Line"."Currency Code" <> '' then CurrExchRate.SetRange("Currency Code", "Gen. Journal Line"."Currency Code");
                                    if CurrExchRate.FindLast()then ExchangeRate:=Format(CurrExchRate."Relational Exch. Rate Amount");
                                end;
                        ...
                        if "Account Type" = "Account Type"::Employee then begin
                            EmpRec.Reset();
                            if EmpRec.get("Account No.")then begin
                                EmpBankRecNew.Reset();
                                if EmpBankRecNew.Get(EmpRec."No.", "Employee Bank Account")then begin
                                    BenBankName:=EmpBankRecNew."Bank Name";
                                    SWIFTBIC:=EmpBankRecNew."SWIFT Code";
                                    BeniBankCountryCode:=EmpBankRecNew."Country/Region Code";
                                    HKClearingBank:=EmpBankRecNew."Bank Clearing Code";
                                    fedwire:=EmpBankRecNew."ABA/BSB No.";
                                    ifsc_code:=EmpBankRecNew."IFSC Code";
                                    Benificierynam:=EmpBankRecNew."Beneficiary Name";
                                    if(EmpBankRecNew."Beneficiary Name 2" = '') and (EmpBankRecNew."Beneficiary Name 3" = '')then begin
                                        // Benificierynam := BankRecNew."Beneficiary Name" + BankRecNew."Beneficiary Name 2";
                                        Benificciyaddress1:=EmpBankRecNew.Address;
                                        Benificciyaddress2:=EmpBankRecNew."Address 2";
                                        Benificciyaddress3:=EmpBankRecNew."Address 3";
                                    end
                                    else if(EmpBankRecNew."Beneficiary Name 2" <> '') and (EmpBankRecNew."Beneficiary Name 3" = '')then begin
                                            Benificciyaddress1:=EmpBankRecNew."Beneficiary Name 2";
                                            Benificciyaddress2:=EmpBankRecNew.Address;
                                            Benificciyaddress3:=EmpBankRecNew."Address 2";
                                        end
                                        else if(EmpBankRecNew."Beneficiary Name 2" <> '') and (EmpBankRecNew."Beneficiary Name 3" <> '')then begin
                                                Benificciyaddress1:=EmpBankRecNew."Beneficiary Name 2";
                                                Benificciyaddress2:=EmpBankRecNew."Beneficiary Name 3";
                                                Benificciyaddress3:=EmpBankRecNew.Address;
                                            end
                                            else if(EmpBankRecNew."Beneficiary Name 2" = '') and (EmpBankRecNew."Beneficiary Name 3" <> '')then begin
                                                    Benificciyaddress1:=EmpBankRecNew."Beneficiary Name 3";
                                                    Benificciyaddress2:=EmpBankRecNew.Address;
                                                    Benificciyaddress3:=EmpBankRecNew."Address 2";
                                                end
                                                else
                                                begin
                                                    Benificierynam:=EmpBankRecNew."Beneficiary Name" + EmpBankRecNew."Beneficiary Name 2";
                                                    Benificciyaddress1:=EmpBankRecNew.Address;
                                                    Benificciyaddress2:=EmpBankRecNew."Address 2";
                                                    Benificciyaddress3:=EmpBankRecNew."Address 3";
                                                end;
                                    ...
                                    //  Benificciyaddress2 := EmpBankRecNew."Address 2";
                                    //  Benificciyaddress3 := EmpBankRecNew."Address 3";
                                    CoorrsspondentbankAccno:=EmpBankRecNew."Correspondent Bank Account No.";
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then CoorrsspondentbankCountrycode:=''
                                    else
                                        CoorrsspondentbankCountrycode:=EmpBankRecNew."Corresp. Country/Region Code";
                                    PaymentDetailsofbeneficiery:="Gen. Journal Line"."Purpose Code";
                                    CountryegionRec.Reset();
                                    if CountryegionRec.Get(EmpBankRecNew."Country/Region Code")then CodeWord:=CountryegionRec."Purpose Code (Citi)  Prefix";
                                    BenificieryCountryjurisdiction:=CountryegionRec.Name;
                                    EmployeeContractNo:='';
                                    TransferInformation:="Gen. Journal Line"."Message to Recipient";
                                    PAymentSetCode:="Gen. Journal Line"."Payment Set Code";
                                    ...
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then Coorrsspondentbankname:=''
                                        ...
                                        Coorrsspondentbankname:=EmpBankRecNew."Correspondent Bank Name";
                                    if "Gen. Journal Line"."No Corresponding Bank for Pmt" = true then CoorrsspondentbankSWIFTBIC:=''
                                    else
                                        CoorrsspondentbankSWIFTBIC:=EmpBankRecNew."Correspondent Swift Code";
                                    paymentdetails:="Gen. Journal Line"."Message to Recipient" + '' + "Gen. Journal Line"."Applied Entries to XML";
                                    BenificieryAccno:=EmpBankRecNew."Bank Account No.";
                                    IBANNo:=EmpBankRecNew.IBAN;
                                    Branch:=EmpBankRecNew.Branch;
                                    CurrExchRate.Reset();
                                    if "Gen. Journal Line"."Currency Code" <> '' then CurrExchRate.SetRange("Currency Code", "Gen. Journal Line"."Currency Code");
                                    if CurrExchRate.FindLast()then ExchangeRate:=Format(CurrExchRate."Relational Exch. Rate Amount");
                                end;
                        ...
                        if "Bal. Account Type" = "Bal. Account Type"::"Bank Account" then begin
                            if BalBankREc.get("Bal. Account No.")then begin
                                BalBankAcNo:=BalBankREc."Bank Account No.";
                                BalBankAccName:=BalBankREc."Account Holder Name";
                                Branch:=BalBankREc."Bank Branch No.";
                                SWIFTBEN:=BalBankREc."SWIFT Code";
                                BalCurrencyCode:=BalBankRec."Currency Code Custom";
                            // OrderingPartyName := comp
                            end;
                        end;
                        GJBatch.Reset();
                        if GJBatch.Get("Gen. Journal Batch"."Journal Template Name", "Gen. Journal Batch".Name)then;
                        PaymentMethodRec.Reset();
                        if PaymentMethodRec.get("Gen. Journal Line"."Payment Method Code")then PaymentTypeValue:=Format(PaymentMethodRec."Payment Type");
                        TransactionType:=Format(PaymentMethodRec."Transaction Type");
                        WorldLinkID:="Gen. Journal Line"."World Link";
                        CompanyInfo.get();
                    ...
                    begin
                        ...
                        if not GenJnlTemplate.Recurring then if GenJnlManagement.GetJournalSimplePageModePreference(PAGE::"General Journal")then SetCurrentKey("Document No.", "Line No.");
                        LastEnteredDocNo:='';
                        if "Gen. Journal Batch"."No. Series" <> '' then begin
    ...
    var BalBankAcNo: Text;
    BalBankAccName: Text;
    ifsc_code: Text;
    BalBankREc: Record "Bank Account";
    TransactionType: Text;
    Benificciyaddress3: Text;
    WorldLinkID: Text;
    CompanyName: Text;
    CompanyAddres1: Text;
    CompanyAddres2: Text;
    CompanyAddres3: Text;
    ChargesAccount: Text;
    BeneficieryBankRoutingMethod: Text;
    CodeWordDescription1: Text;
    CodeWordDescription2: Text;
    FXContract: Text;
    ExchangeRate: Text;
    OrderingPartyIDType: Text;
    OrderingPartyID: Text;
    ...
    ValueDate: Date;
    DebitCurrency: Code[20];
    BenBankName: Text;
    TransferInformation: Text;
    SWIFTBIC: Text;
    BeniBankCountryCode: Text;
    BenificieryCountryjurisdiction: Text;
    CountryRegion: Record "Country/Region";
    HKClearingBank: Text;
    fedwire: Text;
    SWIFTBEN: Text;
    Benificierynam: Text;
    Benificciyaddress1: Text;
    ABABSBNo: Text;
    Benificciyaddress2: Text;
    CoorrsspondentbankAccno: Text;
    CoorrsspondentbankCountrycode: Text;
    PaymentDetailsofbeneficiery: Text;
    CodeWord: Text;
    CountryegionRec: Record "Country/Region";
    EmployeeContractNo: Text;
    PAymentSetCode: Text;
    paymentdetails: Text;
    ACHBathRef: Text;
    Coorrsspondentbankname: Text;
    PaymentTypeValue: Text;
    PaymentMethodRec: Record "Payment Method";
    CoorrsspondentbankSWIFTBIC: Text;
    BenificieryAccno: Text;
    IBANNo: text;
    BankRecNew: Record "Vendor Bank Account";
    EmpBankRecNew: Record "Employee Bank Account";
    CustRec: Record "Customer";
    CustBankRecNew: Record "Customer Bank Account";
    ...
    protected var TempGLAccNetChange: Record "G/L Account Net Change" temporary;
    ShowDim: Boolean;
    local procedure CheckRecurringLine(GenJnlLine2: Record "Gen. Journal Line")
    begin
        if GenJnlTemplate.Recurring then begin
            if GenJnlLine2."Recurring Method" = GenJnlLine2."Recurring Method"::" " then AddError(StrSubstNo(Text002, GenJnlLine2.FieldCaption("Recurring Method")));
        ...
        begin
            if GenJnlLine2."Recurring Method" <> GenJnlLine2."Recurring Method"::" " then AddError(StrSubstNo(Text009, GenJnlLine2.FieldCaption("Recurring Method")));
    ...
    begin
        if(GenJnlLine2."Posting Date" <> 0D) and (GenJnlLine2."Account No." <> '') and (GenJnlLine2."Recurring Method" <> GenJnlLine2."Recurring Method"::" ")then AccountingPeriod.MakeRecurringTexts(GenJnlLine2."Posting Date", GenJnlLine2."Document No.", GenJnlLine2.Description);
    end;
    ...
    begin
        ...
        if not GenJnlLine.EmptyLine()then begin
            ...
            if TotalBalance = 0 then VATEntryCreated:=false;
            if GenJnlTemplate."Force Doc. Balance" then begin
                ...
                if(TempGenJournalLineCustVendIC.Count > 1) and VATEntryCreated then AddError(StrSubstNo(Text024, GenJnlLine."Document Type", GenJnlLine."Document No.", GenJnlLine."Posting Date"));
            end;
        end;
        if(LastDate <> 0D) and (LastDocNo <> '') and ((NextGenJnlLine."Posting Date" <> LastDate) or (NextGenJnlLine."Document Type" <> LastDocType) or (NextGenJnlLine."Document No." <> LastDocNo) or (NextGenJnlLine."Line No." = LastLineNo))then begin
            if GenJnlTemplate."Force Doc. Balance" then begin
                case true of DocBalance <> 0: AddError(StrSubstNo(Text025, LastDocType, LastDocNo, DocBalance));
                DocBalanceReverse <> 0: AddError(StrSubstNo(Text026, LastDocType, LastDocNo, DocBalanceReverse));
                end;
                DocBalanceReverse:=0;
            end;
    ...
    var
        ...
        SkipCheck: Boolean;
    begin
        if not DimMgt.CheckDimIDComb(GenJournalLine."Dimension Set ID")then AddError(DimMgt.GetDimCombErr());
        ...
        if not SkipCheck then if not DimMgt.CheckDimValuePosting(TableID, No, GenJournalLine."Dimension Set ID")then AddError(DimMgt.GetDimValuePostingErr());
    end;
    local procedure CalculateDocBalance(GenJournalLine: Record "Gen. Journal Line"): Decimal var
    ...
    local procedure CalculateDateBalance(GenJournalLine: Record "Gen. Journal Line"): Decimal var
        GenJournalLine2: Record "Gen. Journal Line";
    begin
        GenJournalLine2.SetRange("Journal Template Name", GenJournalLine."Journal Template Name");
        GenJournalLine2.SetRange("Journal Batch Name", GenJournalLine."Journal Batch Name");
    ...
    local procedure CalculateTotalBalance(GenJournalLine: Record "Gen. Journal Line"): Decimal var
        GenJournalLine2: Record "Gen. Journal Line";
    begin
        GenJournalLine2.SetRange("Journal Template Name", GenJournalLine."Journal Template Name");
        GenJournalLine2.SetRange("Journal Batch Name", GenJournalLine."Journal Batch Name");
    ...
    begin
        ...
        begin
            ...
            if((Cust.Blocked = Cust.Blocked::All) or ((Cust.Blocked = Cust.Blocked::Invoice) and (GenJnlLine."Document Type" in[GenJnlLine."Document Type"::Invoice, GenJnlLine."Document Type"::" "])))then AddError(StrSubstNo(Text065, GenJnlLine."Account Type", Cust.Blocked, GenJnlLine.FieldCaption("Document Type"), GenJnlLine."Document Type"));
            ...
            CustPosting:=true;
            TestPostingType();
            if GenJnlLine."Recurring Method" = GenJnlLine."Recurring Method"::" " then if GenJnlLine."Document Type" in[GenJnlLine."Document Type"::Invoice, GenJnlLine."Document Type"::"Credit Memo", GenJnlLine."Document Type"::"Finance Charge Memo", GenJnlLine."Document Type"::Reminder]then begin
    ...
    begin
        ...
        begin
            ...
            if((Vend.Blocked = Vend.Blocked::All) or ((Vend.Blocked = Vend.Blocked::Payment) and (GenJnlLine."Document Type" = GenJnlLine."Document Type"::Payment)))then AddError(StrSubstNo(Text065, GenJnlLine."Account Type", Vend.Blocked, GenJnlLine.FieldCaption("Document Type"), GenJnlLine."Document Type"));
            if GenJnlLine."Currency Code" <> '' then if not Currency.Get(GenJnlLine."Currency Code")then AddError(StrSubstNo(Text038, GenJnlLine."Currency Code"));
            ...
            if GenJnlLine."Recurring Method" = GenJnlLine."Recurring Method"::" " then if GenJnlLine."Document Type" in[GenJnlLine."Document Type"::Invoice, GenJnlLine."Document Type"::"Credit Memo", GenJnlLine."Document Type"::"Finance Charge Memo", GenJnlLine."Document Type"::Reminder]then begin
                    ...
                    if PurchSetup."Ext. Doc. No. Mandatory" or (GenJnlLine."External Document No." <> '')then begin
                        ...
                        VendorMgt.SetFilterForExternalDocNo(OldVendLedgEntry, GenJnlLine."Document Type", GenJnlLine."External Document No.", GenJnlLine."Account No.", GenJnlLine."Document Date");
    ...
    begin
        if not Employee.Get(GenJnlLine."Account No.")then AddError(StrSubstNo(Text031, Employee.TableCaption(), GenJnlLine."Account No."))
        else
        begin
            AccName:=Employee."First Name" + ' ' + Employee."Middle Name" + ' ' + Employee."Last Name";
            if Employee."Privacy Blocked" then AddError(StrSubstNo(Text032, Employee.FieldCaption("Privacy Blocked"), false, Employee.TableCaption(), AccName))end;
    end;
    ...
    begin
        ...
        if GenJnlLine."Account Type" = GenJnlLine."Account Type"::"Fixed Asset" then if GenJnlLine.IsAcquisitionCost() or (GenJnlLine."FA Posting Type" in[GenJnlLine."FA Posting Type"::Disposal, GenJnlLine."FA Posting Type"::Maintenance])then begin
            ...
            begin
                if GenJnlLine."Gen. Posting Type" <> GenJnlLine."Gen. Posting Type"::" " then AddError(StrSubstNo(Text049, GenJnlLine.FieldCaption("Gen. Posting Type"), GenJnlLine.FieldCaption("FA Posting Type"), GenJnlLine."FA Posting Type"));
        ...
        if GenJnlLine."Bal. Account Type" = GenJnlLine."Bal. Account Type"::"Fixed Asset" then if GenJnlLine.IsAcquisitionCost() or (GenJnlLine."FA Posting Type" in[GenJnlLine."FA Posting Type"::Disposal, GenJnlLine."FA Posting Type"::Maintenance])then begin
        ...
        if ShouldCheckFAPostingDate then begin
            ...
            if not(GenJnlLine."FA Posting Date" in[DMY2Date(1, 1, 2) .. DMY2Date(31, 12, 9998)])then AddError(StrSubstNo(Text053, GenJnlLine.FieldCaption("FA Posting Date")));
            if(AllowFAPostingFrom = 0D) and (AllowFAPostingTo = 0D)then begin
                ...
                if AllowFAPostingTo = 0D then AllowFAPostingTo:=DMY2Date(31, 12, 9998);
            end;
        ...
        if GenJnlLine."FA Error Entry No." > 0 then begin
            ...
            if GenJnlLine."Recurring Method" <> GenJnlLine."Recurring Method"::" " then AddError(StrSubstNo(TempErrorText, GenJnlLine.FieldCaption("Recurring Method")));
    ...
    begin
        ...
        if GenJnlLine."Job Task No." = '' then AddError(StrSubstNo(Text002, GenJnlLine.FieldCaption("Job Task No.")))
        else if not JT.Get(GenJnlLine."Job No.", GenJnlLine."Job Task No.")then AddError(StrSubstNo(Text071, JT.TableCaption(), GenJnlLine."Job Task No."));
    ...
    begin
        ...
        if GenJnlLine."FA Posting Type" <> GenJnlLine."FA Posting Type"::Maintenance then begin
            ...
            if OldFALedgEntry.FindFirst()then AddError(StrSubstNo(Text073, GenJnlLine.FieldCaption("Document No."), GenJnlLine."Document No."));
        end
        else
        begin
            ...
            if OldMaintenanceLedgEntry.FindFirst()then AddError(StrSubstNo(Text073, GenJnlLine.FieldCaption("Document No."), GenJnlLine."Document No."));
        end;
    end;
    ...
    begin
        case AccountType of AccountType::"G/L Account": CheckGLAcc("Gen. Journal Line", Name);
        AccountType::Customer: CheckCust("Gen. Journal Line", Name);
        AccountType::Vendor: CheckVend("Gen. Journal Line", Name);
        AccountType::"Bank Account": CheckBankAcc("Gen. Journal Line", Name);
        AccountType::"Fixed Asset": CheckFixedAsset("Gen. Journal Line", Name);
        AccountType::"IC Partner": CheckICPartner("Gen. Journal Line", Name);
        AccountType::Employee: CheckEmployee("Gen. Journal Line", Name);
        end;
    end;
    local procedure GetLastEnteredDocumentNo(var FromGenJournalLine: Record "Gen. Journal Line"): Code[20]var
    ...
    local procedure IsGapInNosForDocNo(var FromGenJournalLine: Record "Gen. Journal Line"): Boolean var
        GenJournalLine: Record "Gen. Journal Line";
    begin
        if LastEnteredDocNo = '' then exit(false);
        if FromGenJournalLine."Document No." = LastEnteredDocNo then exit(false);
        GenJournalLine.CopyFilters(FromGenJournalLine);
    ...
    begin
        if(CurrentICPartner <> '') and ("Gen. Journal Line"."IC Direction" = "Gen. Journal Line"."IC Direction"::Outgoing)then begin
            if("Gen. Journal Line"."Account Type" in["Gen. Journal Line"."Account Type"::"G/L Account", "Gen. Journal Line"."Account Type"::"Bank Account"]) and ("Gen. Journal Line"."Bal. Account Type" in["Gen. Journal Line"."Bal. Account Type"::"G/L Account", "Gen. Journal Line"."Account Type"::"Bank Account"]) and ("Gen. Journal Line"."Account No." <> '') and ("Gen. Journal Line"."Bal. Account No." <> '')then AddError(StrSubstNo(Text066, "Gen. Journal Line".FieldCaption("Account No."), "Gen. Journal Line".FieldCaption("Bal. Account No.")))
            else if(("Gen. Journal Line"."Account Type" in["Gen. Journal Line"."Account Type"::"G/L Account", "Gen. Journal Line"."Account Type"::"Bank Account"]) and ("Gen. Journal Line"."Account No." <> '')) xor (("Gen. Journal Line"."Bal. Account Type" in["Gen. Journal Line"."Bal. Account Type"::"G/L Account", "Gen. Journal Line"."Account Type"::"Bank Account"]) and ("Gen. Journal Line"."Bal. Account No." <> ''))then if "Gen. Journal Line"."IC Account No." = '' then AddError(StrSubstNo(Text002, "Gen. Journal Line".FieldCaption("IC Account No.")))
                    else
                    begin
                        if "Gen. Journal Line"."IC Account Type" = "Gen. Journal Line"."IC Account Type"::"G/L Account" then if ICGLAccount.Get("Gen. Journal Line"."IC Account No.")then if ICGLAccount.Blocked then AddError(StrSubstNo(Text032, ICGLAccount.FieldCaption(Blocked), false, "Gen. Journal Line".FieldCaption("IC Account No."), "Gen. Journal Line"."IC Account No."));
                        if "Gen. Journal Line"."IC Account Type" = "Gen. Journal Line"."IC Account Type"::"Bank Account" then if ICBankAccount.Get("Gen. Journal Line"."IC Account No.", CurrentICPartner)then if ICBankAccount.Blocked then AddError(StrSubstNo(Text032, ICGLAccount.FieldCaption(Blocked), false, "Gen. Journal Line".FieldCaption("IC Account No."), "Gen. Journal Line"."IC Account No."));
                    end
