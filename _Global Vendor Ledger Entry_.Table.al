table 55025 "Global Vendor Ledger Entry"
{
    Caption = 'Global Vendor Ledger Entry';
    ...
    fields
    {
        ...
        field(13; Amount; Decimal)
        {
            ...
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry".Amount where("Ledger Entry Amount"=const(true), "Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
            Caption = 'Amount';
            Editable = false;
            FieldClass = FlowField;
        }
        field(14; "Remaining Amount"; Decimal)
        {
            AutoFormatExpression = Rec."Currency Code";
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry".Amount where("Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry"."Amount (LCY)" where("Vendor Ledger Entry No."=field("Entry No."), "Entry Type"=filter("Initial Entry"), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry"."Amount (LCY)" where("Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry"."Amount (LCY)" where("Ledger Entry Amount"=const(true), "Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
            Caption = 'Amount (LCY)';
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(58; "Debit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry"."Debit Amount" where("Ledger Entry Amount"=const(true), "Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(59; "Credit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry"."Credit Amount" where("Ledger Entry Amount"=const(true), "Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(60; "Debit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry"."Debit Amount (LCY)" where("Ledger Entry Amount"=const(true), "Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(61; "Credit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry"."Credit Amount (LCY)" where("Ledger Entry Amount"=const(true), "Vendor Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(75; "Original Amount"; Decimal)
        {
            AutoFormatExpression = Rec."Currency Code";
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Vendor Ledg. Entry".Amount where("Vendor Ledger Entry No."=field("Entry No."), "Entry Type"=filter("Initial Entry"), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(77; "Remaining Pmt. Disc. Possible"; Decimal)
        {
            ...
            begin
                ...
                if "Remaining Pmt. Disc. Possible" * Amount < 0 then FieldError("Remaining Pmt. Disc. Possible", StrSubstNo(MustHaveSameSignErr, FieldCaption(Amount)));
                if Abs("Remaining Pmt. Disc. Possible") > Abs("Original Amount")then FieldError("Remaining Pmt. Disc. Possible", StrSubstNo(MustNotBeLargerErr, FieldCaption("Original Amount")));
            end;
        }
        ...
        field(79; "Max. Payment Tolerance"; Decimal)
        {
            ...
            begin
                ...
                if "Max. Payment Tolerance" * Amount < 0 then FieldError("Max. Payment Tolerance", StrSubstNo(MustHaveSameSignErr, FieldCaption(Amount)));
                if Abs("Max. Payment Tolerance") > Abs("Remaining Amount")then FieldError("Max. Payment Tolerance", StrSubstNo(MustNotBeLargerErr, FieldCaption("Remaining Amount")));
            end;
        }
        ...
        field(84; "Amount to Apply"; Decimal)
        {
            ...
            begin
                ...
                if AreOppositeSign("Amount to Apply", "Remaining Amount")then FieldError("Amount to Apply", StrSubstNo(MustHaveSameSignErr, FieldCaption("Remaining Amount")));
                if Abs("Amount to Apply") > Abs("Remaining Amount")then FieldError("Amount to Apply", StrSubstNo(MustNotBeLargerErr, FieldCaption("Remaining Amount")));
                //TEC-Sgarg>>21jan25
                IF "Company Code" = CompanyName then begin
                    IF L_VLE.GET("Entry No.")then begin
                        L_VLE."Amount to Apply":=rec."Amount to Apply";
                        L_VLE.Modify();
        ...
        field(50100; "Payment Date"; Date)
        {
            ...
            begin
                VendLedgEntry.Reset();
                VendLedgEntry.ChangeCompany(rec."Company Name");
                VendLedgEntry.SetRange("Entry No.", Rec."Entry No.");
                VendLedgEntry.FindSet();
                VendLedgEntry."Payment Date":=Rec."Payment Date";
                VendLedgEntry.Modify();
            end;
        }
        field(50105; "Invoice Link"; Text[1024])
        {
            DataClassification = CustomerContent;
            Caption = 'Invoice Link';
            ExtendedDatatype = URL; //NT_ 14-03-2025
        }
        ...
        field(50013; "Booking Method"; text[20])
        {
            DataClassification = ToBeClassified;
        }
        field(50014; "Ship Manager Id"; text[250])
        {
            DataClassification = ToBeClassified;
        }
        field(50015; "Exported to DNV"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50016; "PB DNV invoice"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    ...
    trigger OnModify()
    begin
    //Error('gloabl vendor ledger onmodify');
    end;
    trigger OnInsert()
    begin
    //if Rec."Document No." = 'USD-DINVO-24000046' then
    // Error('global vendor ledger oninsert');
    end;
    var MustHaveSameSignErr: Label 'must have the same sign as %1';
    ...
    procedure ShowDoc()Result: Boolean var
    ...
    var
        ...
        PurchCrMemoHdr: Record "Purch. Cr. Memo Hdr.";
    begin
        case "Document Type" of "Document Type"::Invoice: if PurchInvHeader.Get("Document No.")then OpenDocumentAttachmentDetails(PurchInvHeader);
        "Document Type"::"Credit Memo": if PurchCrMemoHdr.Get("Document No.")then OpenDocumentAttachmentDetails(PurchCrMemoHdr);
        end;
    end;
    ...
    begin
        case "Document Type" of "Document Type"::Invoice: if PurchInvHeader.Get("Document No.")then exit(DocumentAttachment.HasPostedDocumentAttachment(PurchInvHeader));
        "Document Type"::"Credit Memo": if PurchCrMemoHdr.Get("Document No.")then exit(DocumentAttachment.HasPostedDocumentAttachment(PurchCrMemoHdr));
        end;
    ...
    procedure SetStyle()Result: Text var
        IsHandled: Boolean;
    begin
        IsHandled:=false;
    ...
    begin
        ...
        if(GenJnlLine."Remit-to Code" <> '')then "Remit-to Code":=GenJnlLine."Remit-to Code";
    end;
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            begin
                ...
                if UpdateMaxPaymentTolerance then "Max. Payment Tolerance":=CurrencyExchangeRate.ExchangeAmtFCYToFCY(ApplnDate, "Currency Code", ApplnCurrencyCode, "Max. Payment Tolerance");
