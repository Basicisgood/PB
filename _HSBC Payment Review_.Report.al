report 50117 "HSBC Payment Review"
{
    ApplicationArea = all;
    DefaultLayout = RDLC;
    // WordLayout = './HSBC payment review layout.docx';
    //WordLayout = './HSBCpaymentreview.docx';
    RDLCLayout = './HSBC payment review layout.rdl';
    Caption = 'HSBC Payment Review';
        ...
        dataitem("Gen. Journal Batch"; "Gen. Journal Batch")
        {
            ...
            dataitem("Integer"; Integer)
            {
                ...
                dataitem("Gen. Journal Line"; "Gen. Journal Line")
                {
                    ...
                    // column(ValueDate; GJBatch."Value Date") { }Commented BY**VG>>24NOV2025
                    column(ValueDate; "Posting Date")
                    {
                    } //Changed Value Date to posting date**VG>>24NOV2025
                    column(PaymentTypeValue; PaymentTypeValue)
                    {
                    }
                    column(GLSetup_LCY; GLSetup."LCY Code")
                    {
                    }
                    ...
                    // {
                    // }
                    column(AccountNo_GenJnlLine; DebtAccNo)
                    {
                    }
                    //TEC.VJ 07052025 #378<<
                    ...
                    begin
                        ...
                        if not EmptyLine()then begin
                            ...
                            //TEC.VJ 07052025 #378>>
                            Clear(G_BankAcc);
                            if("Gen. Journal Line"."Bal. Account Type" = "Gen. Journal Line"."Bal. Account Type"::"Bank Account") and ("Gen. Journal Line"."Bal. Account No." <> '')then begin
                                G_BankAcc.Get("Gen. Journal Line"."Bal. Account No.");
                                DebtAccNo:=G_BankAcc."Bank Account No.";
                                AccName:=G_BankAcc."Bank Beneficiary Name";
                            end
                            else
                            begin
                                DebtAccNo:="Gen. Journal Line"."Account No.";
                            end;
                            //TEC.VJ 07052025 #378<<
                        ...
                        if "Account Type" = "Account Type"::Vendor then begin
                            ...
                            if VendRec.get("Account No.")then begin
                                BankRecNew.Reset();
                                BankRecNew.SetRange("Vendor No.", VendRec."No.");
                                BankRecNew.SetRange(Code, "Recipient Bank Account"); //NT_ 20250812 
                                if BankRecNew.FindFirst()then begin
                                    ...
                                    //Benificierynam := BankRecNew."Beneficiary Name";//VG_17Nov2025 --
                                    //VG_17Nov2025 ++
                                    Benificierynam:=BankRecNew."Beneficiary Name" + BankRecNew."Beneficiary Name 2" + BankRecNew."Beneficiary Name 3";
                                    ...
                                    //PaymentDetailsofbeneficiery := "Gen. Journal Line"."Purpose Code";//VJ 13102025---
                                    PaymentDetailsofbeneficiery:="Gen. Journal Line"."Purpose Code" + ' ' + "Gen. Journal Line"."Message to Recipient"; //VJ 13102025+++
                                    CountryegionRec.Reset();
                                    if CountryegionRec.Get(BankRecNew."Country/Region Code")then CodeWord:=CountryegionRec."Purpose Code (HSBC)  Prefix";
                                    EmployeeContractNo:='';
                                    ...
                                    //BenificieryAccno := BankRecNew."Bank Account No." //10102025 VJ Commented
                                    //10102025 VJ Added
                                    if BankRecNew."Bank Account No." <> '' then BenificieryAccno:=BankRecNew."Bank Account No."
                                    else
                                        BenificieryAccno:=BankRecNew.IBAN;
                                //10102025 VJ Added
                                end;
                            end;
                        end;
                        if "Account Type" = "Account Type"::Employee then begin
                            ...
                            if EmpRec.get("Account No.")then begin
                                EmpBankRecNew.Reset();
                                EmpBankRecNew.SetRange("Employee No.", EmpRec."No.");
                                EmpBankRecNew.SetRange(Code, "Recipient Bank Account"); //NT_ 20250812 
                                if EmpBankRecNew.FindFirst()then begin
                                    ...
                                    Benificierynam:=EmpBankRecNew."Beneficiary Name" + EmpBankRecNew."Beneficiary Name 2" + EmpBankRecNew."Beneficiary Name 3";
                                    ...
                                    PaymentDetailsofbeneficiery:="Gen. Journal Line"."Purpose Code" + ' ' + "Gen. Journal Line"."Message to Recipient"; //VJ 13102025+++
                                    CountryegionRec.Reset();
                                    if CountryegionRec.Get(EmpBankRecNew."Country/Region Code")then CodeWord:=CountryegionRec."Purpose Code (HSBC)  Prefix";
                                    EmployeeContractNo:='';
                                    TransferInformation:="Gen. Journal Line"."Message to Recipient";
                                    PAymentSetCode:="Gen. Journal Line"."Payment Set Code";
                                    ACHBathRef:='';
                                    ...
                                    paymentdetails:="Gen. Journal Line"."Message to Recipient" + '' + "Gen. Journal Line"."Applied Entries to XML";
                                    //BenificieryAccno := EmpBankRecNew."Bank Account No.";//10102025 VG Commented
                                    //10102025 VJ Added
                                    if EmpBankRecNew."Bank Account No." <> '' then BenificieryAccno:=EmpBankRecNew."Bank Account No."
                                    else
                                        BenificieryAccno:=EmpBankRecNew.IBAN;
                                //10102025 VJ Added
                                end;
                            end;
                        end;
    ...
    var GJBatch: Record "Gen. Journal Batch";
    ValueDate: Date;
    ...
    G_BankAcc: Record "Bank Account";
    DebtAccNo: text[30];
    DebtAccName: Text[100];
