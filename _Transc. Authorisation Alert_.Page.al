page 50172 "Transc. Authorisation Alert"
{
    ApplicationArea = All;
    Caption = 'Transc. Authorisation Alert';
    PageType = List;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the payeeAcctNo field.', Comment = '%';
                    ApplicationArea = All;
                }
                field(payeeAcctName; Rec.payeeAcctName)
                {
                    ToolTip = 'Specifies the value of the payeeAcctName field.', Comment = '%';
                    ApplicationArea = All;
                }
                ...
                {
                    ToolTip = 'Specifies the value of the handledBy field.', Comment = '%';
                    ApplicationArea = All;
                }
