table 50151 "Trans. Authorisation Alert"
{
    Caption = 'Transaction Authorisation Alert';
    ...
    fields
    {
        ...
        field(11; payeeAcctNo; Text[35])
        {
            Caption = 'payeeAcctNo';
            DataClassification = ToBeClassified;
        }
        field(12; payeeAcctName; Text[140])
        {
        ...
        field(15; handledBy; Text[15])
        {
            Caption = 'handledBy';
            DataClassification = ToBeClassified;
        }
        field(16; iGTBRef; Text[11])
        {
            Caption = 'iGTBRef';
            DataClassification = ToBeClassified;
        }
        field(17; custRef; Text[35])
        {
            Caption = 'custRef';
            DataClassification = ToBeClassified;
        }
        field(18; messageBase64; Text[2048])
        {
