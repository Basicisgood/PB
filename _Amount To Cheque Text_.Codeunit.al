codeunit 50203 "Amount To Cheque Text"
{
    trigger OnRun()
    begin
    end;
    ...
    procedure FormatNoText(var NoText: array[2]of Text[80]; No: Decimal; CurrencyCode: Code[10]; p_rec_GenJnlLine: Record "Gen. Journal Line")
    var
    ...
    begin
        ...
        if No <> 0 then begin
            ...
            DecimalPosition:=GetAmtDecimalPosition(p_rec_GenJnlLine);
    ...
    local procedure GetAmtDecimalPosition(p_rec_GenJnlLine: Record "Gen. Journal Line"): Decimal var
        Currency: Record Currency;
    begin
        if p_rec_GenJnlLine."Currency Code" = '' then Currency.InitRoundingPrecision()
        else
        begin
            Currency.Get(p_rec_GenJnlLine."Currency Code");
