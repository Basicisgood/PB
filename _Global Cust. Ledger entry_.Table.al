table 50147 "Global Cust. Ledger entry"
{
    Caption = 'Global Cust. Ledger Entry';
    DrillDownPageID = "Global Cust. Ledger Entries";
    LookupPageID = "Global Cust. Ledger Entries";
    ...
    fields
    {
        ...
        field(2; "Company Name"; Code[50])
        {
            Caption = 'Company Name';
        }
        field(90000; "Company Code"; Text[255])
        {
        ...
        field(13; Amount; Decimal)
        {
            ...
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry".Amount where("Ledger Entry Amount"=const(true), "Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
            Caption = 'Amount';
            Editable = false;
            FieldClass = FlowField;
        }
        field(14; "Remaining Amount"; Decimal)
        {
            AutoFormatExpression = Rec."Currency Code";
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry".Amount where("Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry"."Amount (LCY)" where("Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Entry Type"=filter("Initial Entry"), "Posting Date"=field("Date Filter")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry"."Amount (LCY)" where("Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry"."Amount (LCY)" where("Ledger Entry Amount"=const(true), "Company Name"=field("Company Name"), "Cust. Ledger Entry No."=field("Entry No."), "Posting Date"=field("Date Filter")));
            Caption = 'Amount (LCY)';
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(33; "On Hold"; Code[3])
        {
            ...
            begin
                if "On Hold" = xRec."On Hold" then exit;
                ...
                if GenJournalLine.FIndFirst()then if not Confirm(StrSubstNo(NetBalanceOnHoldErr, GenJournalLine."Journal Template Name", GenJournalLine."Journal Batch Name", GenJournalLine."Line No."))then Error('');
            end;
        }
        ...
        field(37; "Due Date"; Date)
        {
            ...
            begin
                ...
                if "Due Date" <> xRec."Due Date" then begin
                    ...
                    if ReminderEntry.FindLast()then ReminderIssue.ChangeDueDate(ReminderEntry, "Due Date", xRec."Due Date");
                end;
            end;
        }
        ...
        field(44; "Closed by Entry No."; Integer)
        {
            ...
            TableRelation = "Global Cust. Ledger entry";
        }
        ...
        field(58; "Debit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry"."Debit Amount" where("Ledger Entry Amount"=const(true), "Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(59; "Credit Amount"; Decimal)
        {
            ...
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry"."Credit Amount" where("Ledger Entry Amount"=const(true), "Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(60; "Debit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry"."Debit Amount (LCY)" where("Ledger Entry Amount"=const(true), "Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(61; "Credit Amount (LCY)"; Decimal)
        {
            AutoFormatType = 1;
            BlankZero = true;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry"."Credit Amount (LCY)" where("Ledger Entry Amount"=const(true), "Cust. Ledger Entry No."=field("Entry No."), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(75; "Original Amount"; Decimal)
        {
            AutoFormatExpression = Rec."Currency Code";
            AutoFormatType = 1;
            CalcFormula = sum("GB Detailed Cust. Ledg. Entry".Amount where("Cust. Ledger Entry No."=field("Entry No."), "Entry Type"=filter("Initial Entry"), "Company Name"=field("Company Name"), "Posting Date"=field("Date Filter")));
        ...
        field(77; "Remaining Pmt. Disc. Possible"; Decimal)
        {
            ...
            begin
                ...
                if "Remaining Pmt. Disc. Possible" * Amount < 0 then FieldError("Remaining Pmt. Disc. Possible", StrSubstNo(Text000, FieldCaption(Amount)));
                if Abs("Remaining Pmt. Disc. Possible") > Abs("Original Amount")then FieldError("Remaining Pmt. Disc. Possible", StrSubstNo(Text001, FieldCaption("Original Amount")));
            end;
        }
        ...
        field(79; "Max. Payment Tolerance"; Decimal)
        {
            ...
            begin
                ...
                if "Max. Payment Tolerance" * Amount < 0 then FieldError("Max. Payment Tolerance", StrSubstNo(Text000, FieldCaption(Amount)));
                if Abs("Max. Payment Tolerance") > Abs("Remaining Amount")then FieldError("Max. Payment Tolerance", StrSubstNo(Text001, FieldCaption("Remaining Amount")));
            end;
        }
        ...
        field(84; "Amount to Apply"; Decimal)
        {
            ...
            trigger OnValidate()
            var
                CustLedger: Record "Global Cust. Ledger Entry";
                L_CLE: Record "Cust. Ledger Entry";
            begin
                TestField(Open, true);
                CalcFields("Remaining Amount");
                if AreOppositeSign("Amount to Apply", "Remaining Amount")then FieldError("Amount to Apply", StrSubstNo(Text000, FieldCaption("Remaining Amount")));
                if Abs("Amount to Apply") > Abs("Remaining Amount")then FieldError("Amount to Apply", StrSubstNo(Text001, FieldCaption("Remaining Amount")));
                //TEC.VJ 06MAR2025>>
                IF "Company Code" = CompanyName then begin
                    IF L_CLE.GET("Entry No.")then begin
                        L_CLE."Amount to Apply":=rec."Amount to Apply";
                        L_CLE.Modify();
                    end end //TEC.VJ 06MAR2025<<
            end;
        }
        ...
        field(1340; "Dispute Status"; Code[10])
        {
            ...
            begin
                if Rec."Dispute Status" = '' then exit;
                if DisputeStatus.get(Rec."Dispute Status")then if DisputeStatus."Overwrite on hold" then "On Hold":=MarkedAsOnHoldLbl;
            end;
        }
    ...
    keys
    {
        key(Key1; "Entry No.", "Company Name")
        {
            Clustered = true;
        }
    ...
    var Text000: Label 'must have the same sign as %1';
    ...
    begin
        ...
        if IsHandled then exit(IsPageOpened);
        ...
        "Document Type"::"Finance Charge Memo": if IssuedFinChargeMemoHeader.Get("Document No.")then begin
                PAGE.Run(PAGE::"Issued Finance Charge Memo", IssuedFinChargeMemoHeader);
                exit(true);
            end;
        "Document Type"::Reminder: if IssuedReminderHeader.Get("Document No.")then begin
    ...
    begin
        case "Document Type" of "Document Type"::Invoice: begin
            if SalesInvoiceHeader.Get("Document No.")then OpenDocumentAttachmentDetails(SalesInvoiceHeader);
            if ServiceInvoiceHeader.Get("Document No.")then OpenDocumentAttachmentDetails(ServiceInvoiceHeader);
        end;
        "Document Type"::"Credit Memo": begin
            if SalesCrMemoHeader.Get("Document No.")then OpenDocumentAttachmentDetails(SalesCrMemoHeader);
            if ServiceCrMemoHeader.Get("Document No.")then OpenDocumentAttachmentDetails(ServiceCrMemoHeader);
        end;
        end;
    ...
    procedure HasPostedDocAttachment(): Boolean var
    ...
    begin
        case "Document Type" of "Document Type"::Invoice: begin
            if SalesInvoiceHeader.Get("Document No.")then exit(DocumentAttachment.HasPostedDocumentAttachment(SalesInvoiceHeader));
            if ServiceInvoiceHeader.Get("Document No.")then exit(DocumentAttachment.HasPostedDocumentAttachment(ServiceInvoiceHeader));
        end;
        "Document Type"::"Credit Memo": begin
            if SalesCrMemoHeader.Get("Document No.")then exit(DocumentAttachment.HasPostedDocumentAttachment(SalesCrMemoHeader));
            if ServiceCrMemoHeader.Get("Document No.")then exit(DocumentAttachment.HasPostedDocumentAttachment(ServiceCrMemoHeader));
        end;
        end;
        OnAfterHasPostedDocAttachment(Rec, HasPostedDocumentAttachment);
        exit(HasPostedDocumentAttachment);
    end;
    procedure DrillDownOnEntries(var DtldCustLedgEntry: Record "GB Detailed Cust. Ledg. Entry")
    var
    ...
    procedure DrillDownOnOverdueEntries(var DtldCustLedgEntry: Record "GB Detailed Cust. Ledg. Entry")
    var
        CustLedgEntry: Record "Global Cust. Ledger Entry";
        DrillDownPageID: Integer;
        IsHandled: Boolean;
    ...
    procedure GetAdjustedCurrencyFactor(): Decimal begin
        if "Adjusted Currency Factor" = 0 then exit(1);
    ...
    procedure SetStyle()Style: Text var
        IsHandled: Boolean;
    begin
        OnBeforeSetStyle(Style, IsHandled);
        if IsHandled then exit(Style);
        if Open then begin
    ...
    begin
        ...
        else if ApplyDocType <> 0 then begin
                SetRange("Document Type", ApplyDocType);
                if FindFirst()then;
                SetRange("Document Type");
            end
            else if ApplyAmount <> 0 then begin
    ...
    begin
        ...
        if FindFirst()then begin
            ...
            CODEUNIT.Run(CODEUNIT::"Global Cust. Entry-Edit", Rec);
        end;
    end;
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            "Remaining Pmt. Disc. Possible":=CurrExchRate.ExchangeAmount("Remaining Pmt. Disc. Possible", FromCurrencyCode, ToCurrencyCode, PostingDate);
    ...
    begin
        ...
        if not IsHandled then begin
            //new
            if "Currency Code" = ApplnCurrencyCode then exit;
            if RoundAmounts then begin
                "Remaining Amount":=CurrencyExchangeRate.ExchangeAmount("Remaining Amount", "Currency Code", ApplnCurrencyCode, ApplnDate);
                "Remaining Pmt. Disc. Possible":=CurrencyExchangeRate.ExchangeAmount("Remaining Pmt. Disc. Possible", "Currency Code", ApplnCurrencyCode, ApplnDate);
                if UpdateMaxPaymentTolerance then "Max. Payment Tolerance":=CurrencyExchangeRate.ExchangeAmount("Max. Payment Tolerance", "Currency Code", ApplnCurrencyCode, ApplnDate);
                "Amount to Apply":=CurrencyExchangeRate.ExchangeAmount("Amount to Apply", "Currency Code", ApplnCurrencyCode, ApplnDate);
            end
            else
            begin
                "Remaining Amount":=CurrencyExchangeRate.ExchangeAmtFCYToFCY(ApplnDate, "Currency Code", ApplnCurrencyCode, "Remaining Amount");
                "Remaining Pmt. Disc. Possible":=CurrencyExchangeRate.ExchangeAmtFCYToFCY(ApplnDate, "Currency Code", ApplnCurrencyCode, "Remaining Pmt. Disc. Possible");
 ...
 "Max. Payment Tolerance":=CurrencyExchangeRate.ExchangeAmtFCYToFCY(ApplnDate, "Currency Code", ApplnCurrencyCode, "Max. Payment Tolerance");
                "Amount to Apply":=CurrencyExchangeRate.ExchangeAmtFCYToFCY(ApplnDate, "Currency Code", ApplnCurrencyCode, "Amount to Apply");
            end;
        end;
        OnAfterUpdateAmountsForApplication(Rec, ApplnDate, ApplnCurrencyCode, RoundAmounts, UpdateMaxPaymentTolerance);
    end;
    procedure GetRemainingPmtDiscPossible(ReferenceDate: Date)RemainingPmtDiscPossible: Decimal begin
    ...
    local procedure OnAfterCopyCustLedgerEntryFromGenJnlLine(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; GenJournalLine: Record "Gen. Journal Line")
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyCustLedgerEntryFromCVLedgEntryBuffer(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; CVLedgerEntryBuffer: Record "CV Ledger Entry Buffer")
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnAfterRecalculateAmounts(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; FromCurrencyCode: Code[10]; ToCurrencyCode: Code[10]; PostingDate: Date)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnAfterShowDoc(var CustLedgerEntry: Record "Global Cust. Ledger Entry")
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnAfterShowPostedDocAttachment(var CustLedgerEntry: Record "Global Cust. Ledger Entry")
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnAfterHasPostedDocAttachment(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; var HasPostedDocumentAttachment: Boolean)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeDrillDownEntries(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; var DetailedCustLedgEntry: Record "GB Detailed Cust. Ledg. Entry"; var DrillDownPageID: Integer)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeDrillDownOnOverdueEntries(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; var DetailedCustLedgEntry: Record "GB Detailed Cust. Ledg. Entry"; var DrillDownPageID: Integer)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeSetAmountToApply(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; AppliesToDocNo: Code[20]; CustomerNo: Code[20])
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeShowDoc(CustLedgerEntry: Record "Global Cust. Ledger Entry"; var IsPageOpened: Boolean; var IsHandled: Boolean)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateMessagetoRecipient(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; var IsHandled: Boolean)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnAfterUpdateAmountsForApplication(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; ApplnDate: Date; ApplnCurrencyCode: Code[10]; RoundAmounts: Boolean; UpdateMaxPaymentTolerance: Boolean)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnAfterGetRemainingPmtDiscPossible(CustLedgerEntry: Record "Global Cust. Ledger Entry"; ReferenceDate: Date; var RemainingPmtDiscPossible: Decimal)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeDrillDownOnOverdueEntriesBeforeCode(var DetailedCustLedgEntry: Record "GB Detailed Cust. Ledg. Entry"; var IsHandled: Boolean)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeRecalculateAmounts(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; FromCurrencyCode: Code[10]; ToCurrencyCode: Code[10]; PostingDate: Date; var IsHandled: Boolean)
    begin
    end;
    [IntegrationEvent(false, false)]
    local procedure OnBeforeUpdateAmountsForApplication(var CustLedgerEntry: Record "Global Cust. Ledger Entry"; ApplnDate: Date; ApplnCurrencyCode: Code[10]; RoundAmounts: Boolean; UpdateMaxPaymentTolerance: Boolean; var IsHandled: Boolean)
    begin
    end;
}
